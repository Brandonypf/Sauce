...
async function request<T>(path: string, init: RequestInit = {}): Promise<T> {
  // La cabecera solo va cuando hay cuerpo. Anunciar `application/json` sin enviar
  // nada hace que un servidor estricto rechace la peticion antes de mirarla, y
  // varios endpoints (`/access`, `/logout`) son POST sin cuerpo.
