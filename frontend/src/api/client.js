...
export const api = {
  ...
  creators: {
    onchain: () => request("/api/creators/me/onchain"),
    get: (handle) =>
    ...
    registration: (slug) => request(`/api/works/${slug}/registration`),
    register: (slug, input) => request(`/api/works/${slug}/registration`, { method: "POST", body: JSON.stringify(input) }),
  },
...
orders: {
  ...
  redeemTx: (id) => request(`/api/orders/${id}/redeem-tx`),
